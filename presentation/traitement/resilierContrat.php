            ...
            <tbody>
                ...
                <?php foreach ($listContrat as $contrat): ?>
                    <tr>
                        ...
                        <td>
                            <a href="../../traitement/resilierContratT.php?id=<?php echo $contrat->getNumContrat(); ?>"
                                style="background-color: #0cbb29; color: white; padding: 7px 10px; margin: 4px 0; border: none; cursor: pointer; width: 100%;"
                                onclick="return confirm('Êtes-vous sûr de vouloir modifier cette news ?')">Résilier</a>
                        </td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
