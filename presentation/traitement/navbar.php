...
<nav class="navbar" style="border-radius: 5px">
        ...
        <li style="color: white;"><a href="../acceuil.php">Accueil</a></li>
            ...
            <li class="dropdown" style="color: white;">
                Traitement
                <ul class="dropdown-menu">
                <li><a href="passerContrat.php">Passer un Contrat</a></li>
                <li><a href="modifierContrat.php">Modifier un Contrat</a></li>
                <li><a href="resilierContrat.php">Résilier un Contrat</a></li>
                </ul>
            </li>
            <li class="dropdown" style="color: white;">
                Impression
